...
import {
  ...
  DEFAULT_VIEW_INDEX,
  EXPLORE_EYE_HEIGHT,
  EXPLORE_LOOK_SENSITIVITY,
  EXPLORE_MARGIN,
  EXPLORE_MAX_ELEVATION_OFFSET,
  EXPLORE_MIN_ELEVATION_OFFSET,
  EXPLORE_MOVE_SPEED,
  EXPLORE_ROTATE_SPEED,
  EXPLORE_STEP_HEIGHT,
  EXPLORE_VERTICAL_SPEED,
  RECOMMENDED_CAPTURE_VIEW,
  RESOLVED_EXPLORE_PERCHES,
  SURVEY_DRAG_PITCH_SENSITIVITY,
  SURVEY_DRAG_YAW_SENSITIVITY,
  SURVEY_ROTATE_SPEED,
  SURVEY_LOOK_DISTANCE,
  SURVEY_VIEWS,
  clamp,
  clampExplorePitch,
  clampTerrainBounds,
  clampSurveyPitch,
  collectSceneSubjects,
  createExploreState,
  describeBrushStrength,
  describeDecayAmount,
  directionToYawPitch,
  getRecommendedCaptureView,
  getTouchDistance,
  type CameraOverride,
  type ExploreState,
  type SketchbookInteractionMode,
  type TerrainHeightSampler,
} from './sketchbookCamera'

export type { SketchbookInteractionMode } from './sketchbookCamera'
...
const ignoreCursorChange = () => undefined
...
const SketchbookCanvas = forwardRef<SketchbookCanvasHandle, SketchbookCanvasProps>(function SketchbookCanvas({
  ...
  const emitCursorChange = onCursorChange ?? ignoreCursorChange
