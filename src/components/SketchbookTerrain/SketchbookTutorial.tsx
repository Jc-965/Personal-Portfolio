...
const TUTORIAL_STEPS: TutorialStep[] = [
  {
    ...
    body: 'Start in sculpt view. Drag the camera to orbit, scroll to zoom, then flip sculpt on when you want to push, pull, and smooth the paper landscape.',
    ...
    controls: ['drag orbit', 'scroll zoom', 'sculpt on', 'raise or lower'],
    callouts: [
  ...
  },
  {
    ...
    body: 'Hit explore, click the field to capture your view, then move with WASD. Use Z and C to tilt the camera and escape when you want the cursor back.',
    featureLabel: 'field note',
    ...
    controls: ['explore mode', 'click to look', 'wasd walk', 'z/c tilt', 'esc release'],
    callouts: [
