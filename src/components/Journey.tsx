...
const experiences: Experience[] = [
  ...
  },
  {
    ...
    location: 'Remote',
    status: 'Now',
    summary: 'Engineered production-grade Flutter/Dart mobile features serving 1.5k+ users. Integrated Dio networking, AWS Amplify/Firebase services, and stateful onboarding flows to keep personalized health experiences responsive and consistent across sessions.',
  ...
  },
  {
    ...
    location: 'Pittsburgh, PA',
    status: 'Now',
    summary: 'Engineered Python geospatial pipelines spanning 142 buildings and 1.2K+ path segments. Normalized OpenStreetMap data into validated, versioned JSON artifacts with automated S3 publishing and geometry checks for accurate downstream rendering and search.',
  ...
  },
  {
    ...
    location: 'Pomona, CA',
    summary: "Built reproducible Python pipelines for multimodal speech and motion analysis in a Parkinson's mobile-health study. Applied NumPy, Pandas, and scikit-learn for feature extraction and experimental validation, contributing to a peer-reviewed CCSIT publication.",
